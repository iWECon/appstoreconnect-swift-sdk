...
extension APIEndpoint.V1.AppStoreVersions.WithID {
	...
	public struct AppStoreVersionLocalizations {
		...
		public func get(fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations]? = nil, limit: Int? = nil) -> Request<AppStoreConnectSwiftSDK.AppStoreVersionLocalizationsResponse> {
